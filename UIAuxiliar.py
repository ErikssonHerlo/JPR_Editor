...
# Frame del canvas
frameEditors = Frame(canvas, bg="white")
canvas.create_window((0, 0), window=frameEditors, anchor="nw")
canvas.configure(width=1500, height=650)

# Componentes
#Archivo Label
archivoLbl= Label(frameEditors, text="Archivo sin guardar",width=77,background="snow",fg="white")
archivoLbl.grid(column=0, row=1,sticky="nw",padx=25)
# Label de fila y columna
posicionLbl= Label(frameEditors, text="Fila: 0, Columna: 0",width=20,background="white",fg="blue4")
...
linesLbl = Canvas(frameEditors, width=30, height=258, background='white')
